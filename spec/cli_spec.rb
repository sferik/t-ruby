...
55709764298092545  Apr  6  2011  @sferik      The problem with your code is t...
    ...
    context '--medium' do
      before do
        @cli.options = @cli.options.merge('medium' => true)
      end
      it 'outputs in medium format' do
        @cli.status('55709764298092545')
        expect($stdout.string).to eq <<-eos
Posted at     Screen name  Text                           ...
Apr  6  2011  @sferik      The problem with your code is t...
        eos
      end
    end
...
4611686018427387904  Sep  7 08:35  @mutgoff          Happy Birthday @imdane. ...
 ...
 244099460672679938  Sep  7 07:47  @dwiskus          Gentlemen, you can't fig...
      ...
      it 'outputs in medium format' do
        ...
        expect($stdout.string).to eq <<-eos
Posted at     Screen name       Text
Sep  7 08:35  @mutgoff          Happy Birthday @imdane. ...
Sep  7 08:33  @ironicsans       If you like good real-li...
Sep  7 08:30  @pat_shaughnessy  Something else to vote f...
Sep  7 08:28  @calebelston      Pushing the button to la...
Sep  7 08:23  @calebelston      RT @olivercameron: Mosai...
Sep  7 08:20  @fivethirtyeight  The Weatherman is Not a ...
Sep  7 08:20  @codeforamerica   RT @randomhacks: Going t...
Sep  7 08:17  @fbjork           RT @jondot: Just publish...
Sep  7 08:14  @mbostock         If you are wondering how...
Sep  7 08:11  @FakeDorsey       "Write drunk. Edit sober...
Sep  7 08:07  @al3x             RT @wcmaier: Better bank...
Sep  7 08:05  @calebelston      We just announced Mosaic...
Sep  7 08:01  @BarackObama      Donate $10 or more --> g...
Sep  7 08:00  @JEG2             RT @tenderlove: If corpo...
Sep  7 08:00  @eveningedition   LDN—Obama's nomination; ...
Sep  7 08:00  @dhh              RT @ggreenwald: Democrat...
Sep  7 07:59  @jasonfried       The story of Mars Curios...
Sep  7 07:57  @sferik           @episod @twitterapi now ...
Sep  7 07:50  @sferik           @episod @twitterapi Did ...
Sep  7 07:47  @dwiskus          Gentlemen, you can't fig...
        eos
      end
      context '--reverse' do
        before do
